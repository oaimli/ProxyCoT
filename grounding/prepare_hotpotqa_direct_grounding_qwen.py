...
if __name__ == "__main__":
    ...
    samples_train = []
    samples_dev = []
    with jsonlines.open("../teacher_proxy/hotpotqa_proxy_qwen3_235b_a22b_think_0527_train.jsonl") as reader:
        for line in reader:
            samples_train.append(line)
    with jsonlines.open("../teacher_proxy/hotpotqa_proxy_qwen3_235b_a22b_think_0527_dev.jsonl") as reader:
        for line in reader:
    ...
    data_folder = "hotpotqa_data_direct_grounding_qwen"
