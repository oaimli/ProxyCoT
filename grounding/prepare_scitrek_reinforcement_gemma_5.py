...
if __name__ == "__main__":
    ...
    samples_train = []
    samples_dev = []
    with jsonlines.open("../reasoning/openrlhf/scitrek_proxy_gemma3_4b_it_rl_proxy_train.jsonl") as reader:
        for line in reader:
            samples_train.append(line)
    with jsonlines.open("../reasoning/openrlhf/scitrek_proxy_gemma3_4b_it_rl_proxy_dev.jsonl") as reader:
        for line in reader:
    ...
    data_folder = "scitrek_data_reinforcement_gemma_5"
