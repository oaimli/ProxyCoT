...
if __name__ == "__main__":
    ...
    output_files = ["scitrek_table_qwen3_235b_a22b_thinking_0527_test.jsonl"]
    for generation_file in output_files:
        ...
        print("filtering+aggregating", len(answers_filtering_aggregating),
              len(generation_batches_filtering_aggregating))
