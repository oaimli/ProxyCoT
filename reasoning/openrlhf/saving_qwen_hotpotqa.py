...
# combine model weights with zero_to_fp32, and save to global_step150_tmp
...
path_hf_weights = "checkpoint_hotpotqa_qwen/_actor/global_step150_tmp"
path_hf_tokenizer = "checkpoint_hotpotqa_qwen/_actor/global_step150_tmp"
...
model.save_pretrained("checkpoint_hotpotqa_qwen/_actor/global_step150_hf", safe_serialization=True)
tokenizer.save_pretrained("checkpoint_hotpotqa_qwen/_actor/global_step150_hf")