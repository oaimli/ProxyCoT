...
ray job submit --address="http://127.0.0.1:8265" \
   ...
   --save_path $SCRIPT_DIR/output_scitrek_1t5_qwen \
   --ckpt_path $SCRIPT_DIR/checkpoint_scitrek_1t5_qwen \
   --max_ckpt_num 1 \
   ...
   --init_kl_coef 0.0 \
   --prompt_data json@$SCRIPT_DIR/scitrek_data_1t5/ \
   --eval_dataset json@$SCRIPT_DIR/scitrek_data_1t5/ \
   --input_key messages \
   --label_key answer \
   --apply_chat_template \
   --normalize_reward \
   ...
   --wandb_run_name reasonging_grpo_qwen_scitrek_1t5 \
