...
def get_context(sample, sample_contexts, supporting_sentences, context_sentences):
    ...
    noise_sentences = random.sample(sentences_all, len(supporting_sentences) * 1)
...
def process_data(samples, sample_contexts, context_sentences):
    ...
    for sample in tqdm(samples):
        ...
        mixed_sentences = get_context(sample, sample_contexts, supporting_sentences, context_sentences)
...
if __name__ == "__main__":
    ...
    with open("../possible_proxies/context_sentences_hotpotqa_training.json") as f:
    ...
    saved_folder = "hotpotqa_data_1t1"
