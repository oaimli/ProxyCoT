...
if __name__ == "__main__":
    ...
    # random_scitrek
    data_folder = "scitrek_data_random"
    if os.path.exists(data_folder):
        ...
        print(np.mean(contexts_length), np.std(contexts_length), np.max(contexts_length))


    # random_hotpotqa
    data_folder = "hotpotqa_data_random"
    if os.path.exists(data_folder):
        print(data_folder)
        samples_train = []
        with jsonlines.open(os.path.join(data_folder, "train.jsonl")) as reader:
    ...
    # fields_scitrek
    data_folder = "scitrek_data_fields"
    if os.path.exists(data_folder):
        print(data_folder)
        samples_train = []
        with jsonlines.open(os.path.join(data_folder, "train.jsonl")) as reader:
    ...
    # related_hotpotqa
    data_folder = "hotpotqa_data_related"
    if os.path.exists(data_folder):
        print(data_folder)
        samples_train = []
        with jsonlines.open(os.path.join(data_folder, "train.jsonl")) as reader:
