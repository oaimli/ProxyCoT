...
sys.path.append("../")
from preparation.hotpotqa.data_loading import load_test, get_proxy


if __name__ == "__main__":
    COMPILED_REGEX = re.compile(r"\\boxed\{([\s\S]*?)\}")
    dataset_dir = "../preparation/hotpotqa/extended_hotpotqa"
    model_name_official = "oaimli/longtune_hotpotqa_simple_sft_qwen"
    model_name_save = "qwen3_4b_instruct_0527_simple_sft"
    target_mode = "proxy"
    ...
    samples_test, _, _ = load_test(data_folder=dataset_dir)
            ...
            if len(working_instances) == inference_batch_size or (len(working_instances) > 0 and sample_index == len(samples_test) - 1):
                ...
                for working_instance in working_instances:
                    ...
                    prompt_content = prompt_content.replace(
                        "Please reason step by step, and put your final answer without any formatting within \\boxed{}.",
                ...
                for conversation_output, working_instance in zip(conversation_outputs, working_instances):
                    ...
                    working_outputs.append([generations])
                ...
                for working_output, working_instance in zip(working_outputs, working_instances):
                    ...
                    sample_tmp["generations"] = working_output[0]
