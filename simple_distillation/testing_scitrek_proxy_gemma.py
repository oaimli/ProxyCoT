...
if __name__ == "__main__":
    ...
    model_name_official = "checkpoint_scitrek_teacher_full_gemma/global_step375_hf"
    model_name_save = "gemma3_4b_it_teacher_full"
    target_mode = "proxy"
    inference_batch_size = 128
    vllm_tensor_parallel_size = 4
    vllm_max_model_length = 4096 + 10240
    ...
    sampling_params = SamplingParams(n=3, temperature=1.0, top_p=0.95, top_k=64, max_tokens=10240)
